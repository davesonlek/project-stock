...
class MasterDataServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(Brand::class, MasterDataPolicy::class);
        Gate::policy(Unit::class, MasterDataPolicy::class);
        Gate::policy(Product::class, MasterDataPolicy::class);
        Gate::policy(Goods::class, MasterDataPolicy::class);
        Gate::policy(Supplier::class, MasterDataPolicy::class);
        Gate::policy(GoodsSupplier::class, MasterDataPolicy::class);
        Gate::policy(Warehouse::class, MasterDataPolicy::class);
        Gate::policy(WarehouseLocation::class, MasterDataPolicy::class);
    }
